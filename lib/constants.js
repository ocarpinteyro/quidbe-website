...
export const SITE_TITLE = 'Quidbe'
export const SITE_TITLE_TAB = 'Quidbe: Llamadas de ensueño | Sitio Oficial'
export const SITE_DESCRIPTION = 'Motiva, felicita o corrige a tus niñ@s de una manera fácil y segura. Menos estrés para ti, más inspiración para ellos.'
export const SITE_APP_NAME = 'Quidbe: Llamadas de ensueño'
export const SITE_AUTHOR = 'Quidbe'
export const SITE_DOMAIN = 'https://quidbe.app'
export const SITE_LOGO = 'https://quidbe.app/images/social_share.png'